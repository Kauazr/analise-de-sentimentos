# CONTEÚDO ATUALIZADO DE: popular_banco.py

import sqlite3
import os
# MUDANÇA: Importando os caminhos robustos do config
from config import DB_PATH, SCHEMA_PATH

def criar_e_popular_banco():
    # MUDANÇA: Usando DB_PATH e SCHEMA_PATH
    ...
    try:
        ...
        print(f"Schema do arquivo '{SCHEMA_PATH}' executado.")
        conn.commit()
        
        # ... O resto do arquivo popular_banco.py continua exatamente o mesmo ...
...
if __name__ == "__main__":
    confirmacao = input(f"Este script irá recriar e popular o banco de dados '{os.path.basename(DB_PATH)}' com dados de exemplo. Deseja continuar? (s/N): ")
